    ...
    <main className="flex min-h-screen flex-col bg-paper">
      ...
      <header className="border-b border-border">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
          <span className="font-sans text-sm tracking-[0.2em] uppercase text-ink">PeerLens</span>
          <Link
            href="/login"
            className="btn-ghost"
          >
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-24 sm:py-32">
        <div className="max-w-3xl text-center">
          <p className="mb-8 font-sans text-[11px] tracking-[0.3em] uppercase text-subtle">
            For Product Managers
          </p>
          <h1 className="text-3xl font-light leading-tight text-ink sm:text-4xl lg:text-5xl">
            What would your colleagues say about you?
          </h1>
          <p className="mt-8 text-lg leading-relaxed text-subtle sm:text-xl">
          ...
          <p className="mt-6 font-sans text-xs tracking-wide text-subtle">
      ...
      <div className="border-t border-border px-6 py-20">
        <div className="mx-auto max-w-4xl">
          <h2 className="text-center text-2xl font-light text-ink sm:text-3xl">How it works</h2>
          ...
          <div className="mt-16 grid gap-12 sm:grid-cols-3">
            <div className="text-center">
              <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full border border-border">
                <span className="font-sans text-sm text-subtle">1</span>
              </div>
              <h3 className="mt-6 text-lg text-ink">Rate yourself</h3>
            ...
            <div className="text-center">
              <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full border border-border">
                <span className="font-sans text-sm text-subtle">2</span>
              </div>
              <h3 className="mt-6 text-lg text-ink">Invite peers</h3>
              <p className="mt-3 text-subtle leading-relaxed">
            ...
            <div className="text-center">
              <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full border border-border">
                <span className="font-sans text-sm text-subtle">3</span>
              </div>
              <h3 className="mt-6 text-lg text-ink">Discover gaps</h3>
              <p className="mt-3 text-subtle leading-relaxed">
      ...
      <div className="border-t border-border px-6 py-20">
        <div className="mx-auto max-w-4xl">
          <h2 className="text-center text-2xl font-light text-ink sm:text-3xl">
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div key={skill.name} className="border-l-2 border-border p-6 transition-colors hover:border-subtle">
      ...
      <div className="border-t border-border px-6 py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-2">
            <div className="border-l-2 border-border p-8 text-left">
      ...
      <footer className="border-t border-border px-6 py-10">
        <div className="mx-auto max-w-6xl text-center">
          <p className="font-sans text-xs tracking-wide text-subtle">
