...
type Step = 'prescreen' | 'skills' | 'open_ended' | 'custom' | 'anonymous_note' | 'confirm'
...
export function RespondWizard({ invitationId, requesterName, cycleMode, questions, customQuestions }: Props) {
  ...
  async function handleSubmit() {
    ...
    startTransition(async () => {
      const result = await submitResponse(invitationId, {
      ...
      <div className={`rounded-xl border bg-white p-8 shadow-sm transition-all duration-300 ${
        ...
        {step === 'confirm' && (
          <>
            ...
            <p className="text-gray-600 mb-6">
              Your feedback will be shared {cycleMode === 'anonymous' ? 'anonymously' : 'with your name'} with {requesterName}.
            </p>
